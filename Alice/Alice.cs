...
class Alice
{
    ...
    public static void Main(string[] args)
    {
        ...
        //AES key for sending data from Alice to Bob
        byte[] keyAtoB = Encoding.ASCII.GetBytes("bfaldieqlgslteldi830alcy2ldiacpq");
        byte[] IVAtoB = Encoding.ASCII.GetBytes("yue4950vae92pcid");
        ...
        Thread t1 = new Thread(() =>
    {
        ...
        {
            string message;
            System.IO.StreamReader file = new System.IO.StreamReader(sendFile);
            //read each line of "sendFile", encrypt and send to Bob
            while ((message = file.ReadLine()) != null)
            {
                //Encrypt message
                byte[] body = EncryptStringToBytes(message, keyAtoB, IVAtoB);
        ...
        Thread t2 = new Thread(() =>
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                consumer.Received += (model, ea) =>
                {
                    ...
                    String message = DecryptStringFromBytes(body, keyBtoA, IVBtoA);
                ...
                channel.BasicConsume(queue: "BtoA",
                                     autoAck: true,
                                     consumer: consumer);
                //user press enter to exist the communication
